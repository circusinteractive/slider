...
$('.banners .next').click(slider.nextSlide);
$('.banners .prev').click(slider.prevSlide);


var anim = setInterval(slider.nextSlide, 5000);
$('.banners').hover(
	function(){
		clearInterval(anim);
	},
	function(){
		anim = setInterval(slider.nextSlide, 5000);
	}
);
});
